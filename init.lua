...
-- disable netrw (built-in file explorer) as we'll install nvim-tree later
...
-- Go-specific autoformatting
--
-- Taken from https://github.com/golang/tools/blob/26ef4d1e7e58703248c9a528006b80acced411a6/gopls/doc/vim.md#imports-and-formatting
...
require('lazy').setup({
  ...
  { -- Adds a NERDTree-like file explorer
